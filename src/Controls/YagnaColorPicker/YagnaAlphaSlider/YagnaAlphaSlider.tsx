...
import { IYagnaAlphaSliderProps, IYagnaAlphaSliderStyleProps, IYagnaAlphaSliderStyles } from './YagnaAlphaSlider.types';

const getClassNames = classNamesFunction<IYagnaAlphaSliderStyleProps, IYagnaAlphaSliderStyles>();

export interface IYagnaAlphaSliderState {
  currentValue?: number;
}

export class YagnaAlphaSlider extends React.Component<IYagnaAlphaSliderProps, IYagnaAlphaSliderState> {
    ...
    constructor(props: IYagnaAlphaSliderProps) {
        super(props);
    ...
    public UNSAFE_componentWillReceiveProps(newProps: IYagnaAlphaSliderProps): void {
    ...
    public render(): JSX.Element {
        ...
        return (
            <div ref={this._root} 
                    ...
                    backgroundImage:alphaStyle.backgroundImage,
                    marginBottom:'10px',boxSizing:'border-box'}}>
                <div className={classNames.sliderOverlay} 
                    style={{position:'absolute',left:0,top:0,right:0,bottom:0,
                    width:'100%',height:'100%',background:overlayStyle.background}}/>
