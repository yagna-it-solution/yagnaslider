 ...
 */
export interface IYagnaColorSlider {}

/**
 * {@docCategory ColorPicker}
 */
export interface IYagnaColorSliderProps {
  /**
   * Gets the component ref.
   */
  componentRef?: IRefObject<IYagnaColorSlider>;
   ...
   */
  styles?: IStyleFunctionOrObject<IYagnaColorSliderStyleProps, IYagnaColorSliderStyles>;
}

/**
 * {@docCategory ColorPicker}
 */
export interface IYagnaColorSliderStyleProps {
  /**
   * Theme (provided through customization).
   */
  theme: ITheme;
 ...
 * {@docCategory ColorPicker}
 */
export interface IYagnaColorSliderStyles {
  /**
