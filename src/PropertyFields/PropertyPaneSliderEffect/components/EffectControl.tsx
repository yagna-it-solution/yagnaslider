...
import { IEffectControlProps } from './IEffectControlProps';

export interface IEffectControlState{
    options:any[];
    selectedEffect: string;
}

export default class EffectControl extends React.Component<IEffectControlProps, IEffectControlState> {
    constructor(props: IEffectControlProps, state: IEffectControlState) {
        super(props);
